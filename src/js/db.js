let db = [
  ...
  {
    img: "../src/img/Ship of Fools.png",
    name: "Ship of Fools",
    artist: "Hieronymus Bosch",
    description: `Painting “Ship of Fools”. Why ship? A common metaphor in Bosch's time. This is what they said about the Church. She must “carry” her parishioners through worldly vanity to spiritual purity.
  ...
  {
    img: "../src/img/Temptation of Saint Anthony.png",
    name: "Temptation of Saint Anthony",
    artist: "Hieronymus Bosch",
    description: `Temptation of Saint Anthony. Another fantastic triptych by Bosch. Among the heap of monsters and behemoths are four stories from the life of a hermit.
  ...
  {
    img: "../src/img/Prodigal son.png",
    name: "Prodigal son",
    artist: "Hieronymus Bosch",
    description: `In the painting “Prodigal Son”, instead of a huge number of characters, there is one main character. Traveler.
  ...
  {
    img: "../src/img/Wanderer.png",
    name: "Wanderer",
    artist: "Hieronymus Bosch",
    description: `The meaning here is similar. We are travelers. There is much to be happy about along our journey. But there are also many dangers. Where are we going? And will we get somewhere? Or will we wander like this until death overtakes us on the road?`,
    museum: "http://kosmo-museum.ru",
  },
];
